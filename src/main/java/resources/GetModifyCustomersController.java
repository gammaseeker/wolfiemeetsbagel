 ...
 */
public class GetModifyCustomersController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetModifyCustomersController() {
        super();
...
//		String searchKeyword = request.getParameter("searchKeyword");
		...
		RequestDispatcher rd = request.getRequestDispatcher("modifyCustomers1.jsp");
